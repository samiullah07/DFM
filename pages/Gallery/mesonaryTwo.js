...
export const MyPortfolio = () => { //Not used
  ...
  useEffect(() => {
    ...
    const getItems = async () => { // filtering items function
      ...
      const itemsColRef = collection(db, "MesonaryImages");
      let newItemList = [];
      try {
        ...
        snapshot.docs.forEach((doc) => {
          ...
          doc.data().mesonaryimg.forEach((item) => {
        ...
        <div className="headding" id="Potfolio">
          <Container>
            <div className="portfolio">
              <h1 className="text-center port-title">My Mesonary</h1>
              ...
              <div>
                ...
                >
                  {itemList.map((photo) => (
                    <li
                      className={`photo-item col-lg-6 col-md-4 col-sm-6 col-12`}
                      key={photo.id}
                    >
