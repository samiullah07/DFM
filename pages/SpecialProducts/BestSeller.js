...
//import {login} from "../../component/Cart/Cart";
...
const BestSeller = () => { //
  ...
  const UserItems = async () => { // gets the best seller items
  ...
  const chooseSettings = () => { // this sets the slider settings depending on the amount of items to keep it professional looking
  const baseSettings = {
    dots: false,
    infinite: true,
    speed: 500,
