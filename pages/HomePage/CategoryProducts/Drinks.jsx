...
const Drinks = () => {
  ...
  function calculateAverage(arr) { // used for rating
  ...
  useEffect(() => { // This gets items with the product type Beverages
    ...
    const unsubscribe = onSnapshot(itemsColRef, (snapshot) => {
      ...
      snapshot.docs.forEach((doc) => {
        ...
        data.items.forEach((item) => {
          ...
          if (item.show) {
            if (item.ProductType.includes("Drinks ") || item.ProductType.includes("Beverages")){
